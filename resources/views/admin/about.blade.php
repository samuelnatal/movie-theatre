                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="d-none d-sm-table-cell">Phonneumber</th>
                                        <th class="d-none d-sm-table-cell">Address</th>
                                        <th class="d-none d-sm-table-cell">Youtube</th>
                                        <th class="d-none d-sm-table-cell">Mission</th>
                                        <th class="d-none d-sm-table-cell">Vission</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-w600"><img style="width: 20px;" src="assets/img/avatars/avatar0.jpg" alt=""></td>
                                        <th class="d-none d-sm-table-cell">THS</th>
                                        <td class="font-w600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint dignissimos eius corrupti incidunt dolore minus?</td>
                                        <th class="d-none d-sm-table-cell">0756232334</th>
                                        <th class="d-none d-sm-table-cell">Kigamboni</th>
                                        <th class="d-none d-sm-table-cell">htttp/youtube/kevoo</th>
                                        <th class="d-none d-sm-table-cell">Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto facere in sapiente!</th>
                                        <th class="d-none d-sm-table-cell">Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci illum ratione, dolores natus a cupiditate.</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-info text-light bg-gd-emerald">
                        ...
                        <h3 class="block-title">Add About</h3>
                    ...
                    <form action="" method="post">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    <label for="body">Mission</label>
                                    <textarea name="" id="input" class="form-control" rows="3" required="required"></textarea>
                                  </div>
                                  <div class="form-group">
                                    <label for="body">Vission</label>
                                    <textarea name="" id="input" class="form-control" rows="3" required="required"></textarea>
                                </div>
